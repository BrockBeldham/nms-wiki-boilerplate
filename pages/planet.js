  ...
  return (
    ...
    >
      <div className='frmGroup50' ref={myRef}>
        ...
        <Input id='planet' type='text' label='Moon`s Planet' tooltip='The name of the planet this moon orbits. Leave blank if this is a planet.' onChange={(value) => setPlanet(value)} />
