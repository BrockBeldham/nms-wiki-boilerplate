    ...
    >
      ...
      <div className='frmGroup50' ref={myRef}>
        ...
        <Select
          id='quadrant'
          label='Quadrant'
          tooltip={<p>What quadrant the civilization is located in. Use the minimap in the top left of the galaxy map page. More info on quadrants: <a href='https://nomanssky.fandom.com/wiki/Quadrant' target='_blank' rel='noreferrer'>https://nomanssky.fandom.com/wiki/Quadrant</a>.</p>}
          config={[
        ...
        <Input
          id='system'
          type='text'
          label='Capital Star System Name'
          onChange={(value) => dispatch({ type: 'system', value })}
        />
        <Input
          id='planet'
          type='text'
          label='Capital Planet Name'
      ...
      <div className='frmGroup50'>
        <Select
          ...
          tooltip={<p>How the civilization is governed. More info: <a href='https://nomanssky.fandom.com/wiki/Civilization_Categories#Government' target='_blank' rel='noreferrer'>https://nomanssky.fandom.com/wiki/Civilization_Categories#Government</a></p>}
          config={[
        ...
        <Select
          id='civSize'
          label='Civilization Size'
          tooltip={<p>How large is the civilization. More info: <a href='https://nomanssky.fandom.com/wiki/Civilization_Categories#Size'
          target='_blank' rel='noreferrer'>https://nomanssky.fandom.com/wiki/Civilization_Categories#Size</a></p>}
          config={[
        ...
        <Select
          ...
          tooltip={<p>How does your civilization like to play. More info: <a href='https://nomanssky.fandom.com/wiki/Civilization_Categories#Type' target='_blank' rel='noreferrer'>https://nomanssky.fandom.com/wiki/Civilization_Categories#Type</a></p>}
          config={[
        ...
        <Input
          id='founder'
          type='text'
          label='Civilization Founder In-Game Username'
          onChange={(value) => dispatch({ type: 'founder', value })}
        />
        <Input
          id='founderLink'
          type='text'
          label='Civilization Founder Wiki Username'
          tooltip='If a wiki username is filled, the code will link the civilization to the wiki username. If no wiki username is supplied, the code will "revert" to the In-Game Discoverer Name.'
          onChange={(value) => dispatch({ type: 'founderLink', value })}
        />
        <Input
          id='leader'
          type='text'
          label='Civilization Leader'
          tooltip='Only fill this out if the person who runs the civilization is different than the Founder'
          onChange={(value) => dispatch({ type: 'leader', value })}
        />
        <Select
          id='federation'
          label='Part of the UFT Alliance?'
          config={[
            { value: 'Yes', label :'Yes' },
            { value: 'No', label :'No' }
          ]}
        ...
        <Select
          id='un'
          label='Part of the UN42 Alliance?'
          config={[
            { value: 'Yes', label :'Yes' },
            { value: 'No', label :'No' }
          ]}
        ...
        <SelectMulti
          ...
          isSearchable
          onChange={(items) => dispatch({ type: 'platform', value: items })}
        />
      </div>
      <Textarea
        id='mission'
        label='Civilization`s Mission'
        placeholder='Our mission is to...'
        onChange={(value) => dispatch({ type: 'mission', value })}
      />
      <Textarea
        id='background'
        label='Civilization`s Background/History'
        placeholder='The civilization first started...'
        onChange={(value) => dispatch({ type: 'background', value })}
      />
      <Textarea
        id='guidelines'
        label='Naming Guidlines'
        placeholder='Members are encouraged to name planets/moons with...'
        onChange={(value) => dispatch({ type: 'guidelines', value })}
      />
      <Textarea
        id='joining'
        label='How to Join'
        placeholder='If you want to join, you should...'
        onChange={(value) => dispatch({ type: 'joining', value })}
      />
      <Members
      ...
      <button
        type='button'
        className={`btn ${styles.btn}`}
        onClick={() => dispatch({ type: 'addItemToArray', id: 'rules', value: '' })}>
        Add Rule
      </button>
      <div className='frmGroup50'>
        <Gallery
      ...
      <div className={styles.btnContainer}>
        <button
          ...
          onClick={() => {
            ...
            setViewCode(true);
            ga.event('click', 'View Civilization Code', window.innerWidth < 800 ? 'Popup' : 'ScrollTo');
          }}>
          View Code
        </button>
        <button
          ...
          onClick={() => {
            ...
            ga.event('click', 'Copy Civilization', data.title);
          }}>
        ...
        <a href={`https://nomanssky.fandom.com/wiki/${data.title.replace(/ /g,'_')}?action=edit`}
          ...
          target='_blank'
          rel='noreferrer'
          onClick={() => ga.event('click', 'Create Civilization', data.title)}>
          Create Page
        </a>
      </div>
