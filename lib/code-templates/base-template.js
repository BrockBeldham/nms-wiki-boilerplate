...
| censusplayer = ${data.census ? data.builder : ''}
| censusreddit = ${data.census ? data.reddit : ''}
| censusdiscord = ${data.census ? data.discord : ''}
| censusfriend = ${data.census ? data.friendCode : ''}
| censusarrival = ${data.census ? data.arrival : ''}
| censusrenewal = ${data.census ? new Date().getFullYear() : ''}
| censusshow = ${data.census ? 'Show' : ''}
}}
